...
\begin{center}
    ...
    \caption{Same as Fig \ref{fig:2radec} but also accounting for propper motion. Offsets are now from J2000.0 coordinates (9h22m37.568s +50$^\circ$36'13.48") . Error bars are smaller than the data point.}
    \label{fig:3radec}
\end{center}
\end{figure}
...
\begin{center}
    ...
    \caption{Same as Fig \ref{fig:2time} but also accounting for propper motion. Offsets are now from J2000.0 coordinates (9h22m37.568s +50$^\circ$36'13.48") . Error bars are smaller than the data point.}
    \label{fig:3time}
\end{center}
\end{figure}
